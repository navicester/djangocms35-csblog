    ...
    <div class="col-sm-12">
        <div class="comment-box{% if comment %} success-form{% endif %}">
            ...
            <form action="{% url 'djangocms_comments_save_comment' %}" method="post" class="comment-box-form">
                ...
                <div class="row">
                    {% bootstrap_form_errors form %}
                    <div class="col-sm-12">{% bootstrap_field form.body show_label=false %}</div>
                </div>
                {{ form.config_id }}
                {{ form.page_type }}
                {{ form.page_id }}
        ...
        <div class="col-sm-12">
          <div class="comment-box{% if comment %} success-form{% endif %}">
              ...
              <form action="{% url 'djangocms_comments_save_comment' %}" method="post" class="comment-box-form" novalidate>
                ...
                <div class="control-group">
                  <div class="form-group floating-label-form-group controls">
                    <label for="id_body">Your comments</label>
                    <textarea rows="5" class="form-control" placeholder="Message" id="id_body" name="body" maxlength="12000" minlength="50" required data-validation-required-message="Please enter a message."></textarea>
                    <p class="help-block text-danger"></p>
                  </div>
                </div>
