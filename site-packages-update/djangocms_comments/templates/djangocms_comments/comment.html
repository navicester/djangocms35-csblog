...
<div class="row comment{% if not comment.published %} unpublished{% endif %} {% if comment.moderated == 'spam' %} spam{% endif %}">
    <div class="col-sm-2">
        <img src="{% if comment.author and comment.author.image and comment.author.image.url %}{{comment.author.image.url}}{% else %}http://www.gravatar.com/avatar/{{ comment.author.email|md5 }}{% endif %}" class="avatar" />
    </div>
    <div class="col-sm-10">
        <div class="panel panel-default">
            <div class="panel-heading">        
            ...
            <div class="panel-body">
                ...
                {% if comment.moderated != 'deleted' or is_staff %}
                    <div class="{{ comment.moderated }}" style="margin-bottom: 10px;">{{ comment.body }}</div>
                {% endif %}
